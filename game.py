...
def redraw_window(players, balls, game_time, score):
    ...
    title = TIME_FONT.render("Доска почета", 1, (0, 0, 0))
    start_y = 25
    ...
    # draw time
    text = TIME_FONT.render("Время: " + convert_time(game_time), 1, (0, 0, 0))
    WIN.blit(text, (10, 10))
    # draw score
    text = TIME_FONT.render("Очки: " + str(round(score)), 1, (0, 0, 0))
